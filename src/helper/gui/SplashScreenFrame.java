...
public class SplashScreenFrame extends javax.swing.JFrame {
  ...
  private static SplashScreenFrame theFrame = null;
  ...
  public static void showFrame(String resource) {
    try {
      if (theFrame == null) {
        currentResource = resource;
        theFrame = new SplashScreenFrame();
        theFrame.loadImage(resource);
      } else if (theFrame != null && !currentResource.equals(resource)) {
        theFrame.dispose();
        currentResource = resource;
        theFrame = new SplashScreenFrame();
        theFrame.loadImage(resource);
  ...
  public void loadImage(String resource) throws Exception {
